    ...
    return (
        <div className="space-y-5">
            ...
            <Tabs
                ...
                className="w-full"
            >
                <TabsList className="grid w-full max-w-md grid-cols-2 h-10 bg-muted p-1">
                    <TabsTrigger
                        value="pendientes"
                        className="data-[state=active]:bg-card data-[state=active]:shadow-sm font-medium text-sm"
                    >
